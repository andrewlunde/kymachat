...
CLIENT_ID="$(kubectl -n kymachat get secrets saas-registry-service-binding --ignore-not-found -o jsonpath='{.data.clientid}' | base64 --decode)"
#echo $CLIENT_ID

CLIENT_SECRET="$(kubectl -n kymachat get secrets saas-registry-service-binding --ignore-not-found -o jsonpath='{.data.clientsecret}' | base64 --decode)"
#echo $CLIENT_SECRET

URL="$(kubectl -n kymachat get secrets saas-registry-service-binding --ignore-not-found -o jsonpath='{.data.url}' | base64 --decode)"
#echo $URL
